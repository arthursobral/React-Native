...
import {ImageBackground, Text, StyleSheet, 
    View, TextInput, TouchableOpacity, Platform,
...
export default class Auth extends Component {
    ...
    render () {
        ...
        validations.push(this.state.email && this.state.email.includes('@'));//validação doidera pro email
        ...
        //verificação com operação and se tiver um falso retorna falso e se todos forem verdadeiros retorna verdadeiro
        ...
        return (
            <ImageBackground source={backgroundImage} style={styles.background}>
                ...
                <View style={styles.formContainer}>
                    ...
                    {this.state.stageNew && 
                        <AuthInput icon='asterisk' placeholder= 'Confirme sua senha'  secureTextEntry={true} 
